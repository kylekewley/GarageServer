...
void protobuf_AssignDesc_ProtocolBuffers_2fGarageCommand_2eproto() {
  protobuf_AddDesc_ProtocolBuffers_2fGarageCommand_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "ProtocolBuffers/GarageCommand.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_ProtocolBuffers_2fGarageCommand_2eproto);
}
...
void protobuf_AddDesc_ProtocolBuffers_2fGarageCommand_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n#ProtocolBuffers/GarageCommand.proto\"g\n"
    "\rGarageCommand\022\'\n\007command\030\001 \002(\0162\026.Garage"
    "Command.Command\022\020\n\010garageId\030\002 \002(\r\"\033\n\007Com"
    "mand\022\020\n\014TRIGGER_DOOR\020\001", 142);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ProtocolBuffers/GarageCommand.proto", &protobuf_RegisterTypes);
  GarageCommand::default_instance_ = new GarageCommand();
  GarageCommand::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_ProtocolBuffers_2fGarageCommand_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_ProtocolBuffers_2fGarageCommand_2eproto {
  StaticDescriptorInitializer_ProtocolBuffers_2fGarageCommand_2eproto() {
    protobuf_AddDesc_ProtocolBuffers_2fGarageCommand_2eproto();
  }
} static_descriptor_initializer_ProtocolBuffers_2fGarageCommand_2eproto_;
...
const GarageCommand& GarageCommand::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ProtocolBuffers_2fGarageCommand_2eproto();
